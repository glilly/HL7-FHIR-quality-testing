...
| CMS22v14 | Preventive Care and Screening: Screening for High Blood Pressure and Follow-Up Documented | Substitute for the originally proposed CMS147 slot; CMS147 was not present in the official 2026 EC QDM ZIP. | Qualifying encounter, blood pressure screening, and documented follow-up when indicated. |
...
| TBD diabetes kidney measure | Diabetes kidney-health slot | CMS134 was not present in the official 2026 EC QDM ZIP. Reselect this slot from the final 2026 EC table before implementation. | Diabetes Condition plus kidney-health laboratory or procedure evidence after measure selection. |
...
- The official 2026 EC QDM ZIP does not include CMS147v14 or CMS134v14. CMS22v14 is the active substitute for the CMS147 slot; the diabetes kidney-health slot still needs a replacement measure decision.
